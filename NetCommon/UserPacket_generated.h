...
struct C2S_Register;
struct C2S_RegisterBuilder;

struct S2C_Register;
struct S2C_RegisterBuilder;
...
enum PacketType : uint8_t {
  ...
  PacketType_C2S_Register = 10,
  PacketType_S2C_Register = 11,
  PacketType_MIN = PacketType_NONE,
  PacketType_MAX = PacketType_S2C_Register
};

inline const PacketType (&EnumValuesPacketType())[12] {
  static const PacketType values[] = {
    ...
    PacketType_C2S_Register,
    PacketType_S2C_Register
  };
  return values;
}
...
inline const char *EnumNamePacketType(PacketType e) {
  if (::flatbuffers::IsOutRange(e, PacketType_NONE, PacketType_S2C_Register)) return "";
...
template<> struct PacketTypeTraits<UserPacket::C2S_Register> {
  static const PacketType enum_value = PacketType_C2S_Register;
};

template<> struct PacketTypeTraits<UserPacket::S2C_Register> {
  static const PacketType enum_value = PacketType_S2C_Register;
};
...
struct C2S_Register FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
...
struct C2S_RegisterBuilder {
  ...
  explicit C2S_RegisterBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<C2S_Register> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<C2S_Register>(end);
    return o;
  }
};
...
struct S2C_Register FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef S2C_RegisterBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SUCCESS = 4,
    VT_MESSAGE = 6
  };
...
struct S2C_RegisterBuilder {
  typedef S2C_Register Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(S2C_Register::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  void add_message(::flatbuffers::Offset<::flatbuffers::String> message) {
    fbb_.AddOffset(S2C_Register::VT_MESSAGE, message);
  }
  explicit S2C_RegisterBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<S2C_Register> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<S2C_Register>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<S2C_Register> CreateS2C_Register(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false,
    ::flatbuffers::Offset<::flatbuffers::String> message = 0) {
  S2C_RegisterBuilder builder_(_fbb);
  builder_.add_message(message);
  builder_.add_success(success);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<S2C_Register> CreateS2C_RegisterDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false,
    const char *message = nullptr) {
  auto message__ = message ? _fbb.CreateString(message) : 0;
  return UserPacket::CreateS2C_Register(
      _fbb,
      success,
      message__);
}
...
struct PacketData FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const UserPacket::C2S_Register *data_as_C2S_Register() const {
    return data_type() == UserPacket::PacketType_C2S_Register ? static_cast<const UserPacket::C2S_Register *>(data()) : nullptr;
  }
  const UserPacket::S2C_Register *data_as_S2C_Register() const {
    return data_type() == UserPacket::PacketType_S2C_Register ? static_cast<const UserPacket::S2C_Register *>(data()) : nullptr;
  }
  template <bool B = false>
  bool Verify(::flatbuffers::VerifierTemplate<B> &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const UserPacket::C2S_Register *PacketData::data_as<UserPacket::C2S_Register>() const {
  return data_as_C2S_Register();
}

template<> inline const UserPacket::S2C_Register *PacketData::data_as<UserPacket::S2C_Register>() const {
  return data_as_S2C_Register();
}
...
inline bool VerifyPacketType(::flatbuffers::VerifierTemplate<B> &verifier, const void *obj, PacketType type) {
  switch (type) {
    ...
    case PacketType_C2S_Register: {
      auto ptr = reinterpret_cast<const UserPacket::C2S_Register *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case PacketType_S2C_Register: {
      auto ptr = reinterpret_cast<const UserPacket::S2C_Register *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
